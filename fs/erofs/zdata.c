...
hitted:
	/*
	 * The no-I/O bypass chain is completed asynchronously.  Its pages must
	 * not be reused for an in-place decode, otherwise the LZ4 input can be
	 * overwritten before the decompressor consumes it.
	 */
